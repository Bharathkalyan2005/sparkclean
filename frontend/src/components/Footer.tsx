    ...
    <footer className="footer relative">
      ...
      <div className="max-w-7xl mx-auto px-4 py-14">
        <div className="footer-grid">
          ...
          <div className="col-span-1">
            ...
            <p className="font-dm text-sm leading-relaxed mb-5" style={{ color: '#A3B899' }}>
            ...
            <div className="social-icons">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg flex items-center justify-center transition-colors hover:border-[#C9A84C]/80 hover:text-[#C9A84C]"
                style={{ background: 'rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.6)', border: '1px solid rgba(255,255,255,0.1)' }}>
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg flex items-center justify-center transition-colors hover:border-[#C9A84C]/80 hover:text-[#C9A84C]"
                style={{ background: 'rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.6)', border: '1px solid rgba(255,255,255,0.1)' }}>
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-syne font-bold mb-4 text-[#C9A84C]">Quick Links</h4>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={i}>
                  {link.href ? (
                    <Link to={link.href} className="font-dm text-sm transition-all text-[#A3B899] hover:text-[#C9A84C]">
                      {link.label}
                    </Link>
                  ) : (
                    <button onClick={link.action!} className="font-dm text-sm transition-all text-left text-[#A3B899] hover:text-[#C9A84C]">
                      {link.label}
                    </button>
                  )}
                </li>
          ...
          {/* Services */}
          <div>
            <h4 className="font-syne font-bold mb-4 text-[#C9A84C]">Our Services</h4>
            <ul className="space-y-2.5">
              {Object.entries(servicePriceOverrides).map(([name, price], idx) => (
                <li key={idx}>
                  <Link to="/book" className="font-dm text-sm transition-all text-[#A3B899] hover:text-[#C9A84C]">
                    {name} — ₹{price}
                  </Link>
                </li>
              ))}
      ...
      <div className="py-5" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="footer-bottom max-w-7xl mx-auto px-4">
          ...
          <p className="font-dm text-xs" style={{ color: '#A3B899' }}>
